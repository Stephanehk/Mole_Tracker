...
sys.path.append('/Users/2020shatgiskessell/Desktop/New_Mole_Detector-master/Mole_Detector_1_2/')
...
img = cv2.imread("/Users/2020shatgiskessell/Desktop/New_Mole_Detector-master/Test_Images/mole2.0.jpg")
img2 = cv2.imread("/Users/2020shatgiskessell/Desktop/New_Mole_Detector-master/Test_Images/mole3.0.jpg")
img3 = cv2.imread("/Users/2020shatgiskessell/Desktop/New_Mole_Detector-master/Test_Images/mole4.0.jpg")
img4 = cv2.imread("/Users/2020shatgiskessell/Desktop/New_Mole_Detector-master/Test_Images/mole5.jpg")
...
def blob_detector (img, x_i, y_i):
    ...
    #     found_blobs = compute_stats (num_labels,labels, stats, centroids, img, x_i, y_i, i)
    #     if found_blobs != None:
    #         print ("found")
    #         blobs.extend(found_blobs)
    return blobs
...
def load_video():
    cap = cv2.VideoCapture("/Users/2020shatgiskessell/Desktop/Soccer_Commentary_Generation/Test_Videos/Passing_ST_Missed_Goal_1.mov")
    while (cap.isOpened()):
        ret, frame = cap.read()
        main (frame, 1)
...
def main (img, id_, detect_skin):
    ...
    #----------------------------------
    cv2.imshow('all', img1)
    #cv2.imwrite('all3.png', img1)
    #print (len(blobs))
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    return x,y, len(blobs), img1

main (img2, 1, detect_skin = True)
