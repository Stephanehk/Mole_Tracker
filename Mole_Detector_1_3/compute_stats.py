...
def compute_lobf(roi,id):
    #find contours
    roi_cnt, h = cv2.findContours(roi, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
...
def compute_stats (num_labels,labels, stats, centroids, img, x_i, y_i, i, og):
    ...
    model = load_model('/Users/2020shatgiskessell/Desktop/New_Mole_Detector/Mole_Detector_1_3/my_mole_model.h5')
    ...
    #cv2.imwrite(os.path.join("/Users/2020shatgiskessell/Desktop/New_Mole_Detector/ANN_Images" , "roi3" + str(i) + ".png"), roi)
    ...
    return blobs, roundness, aspect_ratio, formfactor, error, ("roi3" + str(i) + ".png")
